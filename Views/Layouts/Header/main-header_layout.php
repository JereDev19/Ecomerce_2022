...
<head>
  ...
  <script src="/js/home_page/AnimacionScroll.js" defer></script>
            ...
            <div class="menu collapse navbar-collapse order-lg-1 " id="navMenu">
              <ul class="navbar-nav d-flex text-center justify-content mx-auto mb-2 mb-lg-0 me-auto">
                <li class="nav-item px-2 py-2">
                  <a class="hoverable nav-link text-uppercase text-dark fst-normal" id="scroll-top">Inicio</a>
                </li>
                <li class="nav-item px-2 py-2">
                  <a class="hoverable nav-link text-uppercase text-dark fst-normal" id="scroll-destacados">Destacados</a>
                </li>
                <li class="nav-item px-2 py-2">
                  <a class="hoverable nav-link text-uppercase text-dark fst-normal" id="scroll-questions">Preguntas</a>
                </li>
                <li class="nav-item px-2 py-2">
                  <a class="hoverable nav-link text-uppercase text-dark fst-normal" id="scroll-contact">Contacto</a>
                </li>
              </ul>
              </ul>
            </div>
